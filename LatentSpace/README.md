...
supernet train
python main.py --base  configs/latent-diffusion/<config_spec>_supertrain.yaml

architecture search
python xxx.py --base  configs/latent-diffusion/<config_spec>_search.yaml

subnet retraining
python main.py --base  configs/latent-diffusion/<config_spec>_retrain.yaml
